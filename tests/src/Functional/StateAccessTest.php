...
/**
 * @file
 * Contains \Drupal\Tests\content_moderation_state_access\Functional\StateAccessTest.
 */

namespace Drupal\Tests\content_moderation_state_access\Functional;
 ...
 *
 * @group content_moderation_state_access
 */
class StateAccessTest extends BrowserTestBase {
  ...
  public static $modules = [
    'content_moderation_state_access',
    'node',
    'options',
    'user',
    'system',
